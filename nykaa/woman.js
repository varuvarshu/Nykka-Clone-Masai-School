let data = [
  {
    brand: "Twenty dresses  by nykaa fashion keeping it cute dress",
    name: "selena floral FileList",
    price: "1421",
    size: "X,XX,XXL",
    productID: "women1",
    catagory: "Casual",
    img:"https://images-static.nykaa.com/media/catalog/product/0/5/05abdf6dr1122_1.jpg?tr=w-344,h-344,cm-pad_resize"
  },
  {
    brand: "Twenty dresses  by nykaa fashion keeping it cute dress",
    name: "balck bella",
    ...
    productID: "women2",
    catagory: "festive",
    img: "https://images-static.nykaa.com/media/catalog/product/d/f/df5edf6dr1105_1.jpg?tr=w-344,h-344,cm-pad_resize"
  },
  {
    brand: "Twenty dresses  by nykaa fashion keeping it cute dress",
    ...
    productID: "women3",
    catagory: "party",
    img:"https://adn-static1.nykaa.com/nykdesignstudio-images/tr:w-784,/pub/media/catalog/product/f/5/f5506a2NYFS_TWENT00011819_1.jpg?rnd=20200526195200"
  },
  {
    brand: "Puma",
    name: "selena floral FileList",
...
function ShowProducts(data) {
  ...
  data.filter(function(el){return FilterOccation(el)}).filter(function(el){return FilterBrands(el)}).filter(function(el){return FilterSizes(el)}).filter(function(el){return FilterPrices(el)}).forEach(element => {
    ...
    p2.textContent = "Rs." + element.price;
